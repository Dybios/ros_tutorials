...
def tof_laserscan_publisher(frame_id):
    ...
    scan.range_min         = tofscanner.laser.distance_min*0.01
    scan.range_max         = tofscanner.laser.distance_max*0.01
    ...
    while not rospy.is_shutdown():
        ini_angle, end_angle, time_increment, angle_increment, ranges = tofscanner.scan(scale_factor=0.01, reset=True)
